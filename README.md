...
## Overview
This project focuses on analyzing Titanic dataset to understands the passenger demographics and survival behavior. An interactive Excel dashboard was developed to transform the raw passenger data into the meaningful visual insights for analytical and business-style understanding.
...
- Overall survival rate is significantly lower than non-survival rate.  
...
- **Male passengers** experienced the majority of deaths.  
...
- Children and younger passengers generally had improved survival outcomes compared to middle-aged males.
...
## Conclusion
The Titanic dataset reveals strong survival disparities based on **gender**, **passenger class**, and **age**. Female and first-class passengers had significantly higher survival probabilities, while lower class male passengers were most vulnerable group.
...
Businesses and analysts can use similar analytical approaches to:

- Identify high-risk customer segments  
- Perform demographic behavior analysis  
