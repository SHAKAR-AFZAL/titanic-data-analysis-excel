...
## Overview
This project focuses on analyzing the Titanic dataset to understands the passenger demographics and survival behavior. An interactive Excel dashboard was developed to transform the raw passenger data into the meaningful visual insights for analytical and business-style understanding.
